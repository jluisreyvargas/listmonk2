variable "project_name" { type = string default = "listmonk2" }
...
variable "postgres_engine_version" { type = string default = "16.4" }
variable "postgres_major_family" { type = string default = "16" }

variable "db_instance_class" { type = string default = "db.t4g.micro" }
variable "db_allocated_storage" { type = number default = 20 }
variable "db_name" { type = string default = "listmonk" }
variable "db_username" { type = string default = "listmonk" }

variable "listmonk_admin_user" { type = string default = "admin" }
